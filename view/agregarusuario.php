                ...
                <div class="container p-4">
                    <div class="row">
                        <div class="col-md-4 mx-auto">
                          ...
                          <form action="../controller/ACTIONS/act_agregar_usuario.php" method="POST">
                          ...
                          <div class="form-group">
                          <input name="email" type="text" class="form-control"  placeholder="Correo Del Usuario ">
                          </div>
              
                          <div class="form-group">
                          <input name="password" type="text" class="form-control"  placeholder="Contraseña Del Usuario">
                          </div>
