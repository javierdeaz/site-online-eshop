            ...
            <div class="shop-sidebar">
              ...
              <div class="single-widget category">
                ...
                <ul class="categor-list">
                  <li><a href="shop-grid-google-categoria.php?id_cat=2">Hombre</a></li>
                  <li><a href="shop-grid-google-categoria.php?id_cat=1">Mujer</a></li>
                  <li><a href="shop-grid-google-categoria.php?id_cat=4">Niños</a></li>
                  <li><a href="shop-grid-google-categoria.php?id_cat=3">Niñas</a></li>
                </ul>
              </div>
              <!--/ End Single Widget -->
              <!-- Shop By Price -->
