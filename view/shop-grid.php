          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-12">
              ...
              <div class="right-content">
                <ul class="list-main">
                  <li><i class="ti-location-pin"></i> Tienda local</li>
                  <li>
                    <i class="ti-alarm-clock"></i> <a href="#">Oferta diaria</a>
                  </li>
                    ...
                    <div class="navbar-collapse">
                      <div class="nav-inner">
                        <ul class="nav main-menu menu navbar-nav">
                          ...
                          <li>
                            <a href="#"
                              >Tienda<i class="ti-angle-down"></i
                              ><span class="new">Nuevo</span></a
                            >
                            <ul class="dropdown">
                              <li><a href="shop-grid.html">Almacen</a></li>
                              <li><a href="cart.html">Cartera</a></li>
                              <li><a href="checkout.html">Pagos</a></li>
                            </ul>
                          </li>
                          <li><a href="#">Paginas</a></li>
                          <li>
                            <a href="#">Blogger<i class="ti-angle-down"></i></a>
                            <ul class="dropdown">
                              <li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="bread-inner">
              <ul class="bread-list">
                <li>
                  <a href="index1.html">Inicio<i class="ti-arrow-right"></i></a>
                </li>
          ...
          <div class="col-lg-3 col-md-4 col-12">
            <div class="shop-sidebar">
              ...
              <div class="single-widget range">
                <h3 class="title">Compra por precio</h3>
                ...
                <ul class="check-box-list">
                  <li>
                    <label class="checkbox-inline" for="1"
                      ><input name="news" id="1" type="checkbox" />$20.000 -
                      $50.000<span class="count">(3)</span></label
                    >
                  </li>
                  <li>
                    <label class="checkbox-inline" for="2"
                      ><input name="news" id="2" type="checkbox" />$50.000 -
                      $100.000<span class="count">(5)</span></label
                    >
                  </li>
                  <li>
                    <label class="checkbox-inline" for="3"
                      ><input name="news" id="3" type="checkbox" />$100.000 -
                      $250.000<span class="count">(8)</span></label
                    >
                  </li>
                </ul>
              </div>
              ...
              <div class="single-widget recent-post">
                ...
                <div class="single-post first">
                  <div class="image">
                    <img src="static/static_template/images/publication/publication-1.jpg" alt="#" />
                  </div>
                  <div class="content">
                    <h5><a href="#">Blusa amarilla</a></h5>
                ...
                <div class="single-post first">
                  <div class="image">
                    <img src="static/static_template/images/publication/publication-2.jpg" alt="#" />
                  </div>
                  <div class="content">
                    <h5><a href="#">Bluson verdadero</a></h5>
                    <p class="price">$91.500</p>
                    <ul class="reviews">
                      <li class="yellow"><i class="ti-star"></i></li>
                      <li class="yellow"><i class="ti-star"></i></li>
                      <li class="yellow"><i class="ti-star"></i></li>
                ...
                <div class="single-post first">
                  <div class="image">
                    <img src="static/static_template/images/publication/publication-3.jpg" alt="#" />
                  </div>
                  <div class="content">
                    <h5><a href="#">Blusa pasión</a></h5>
                    <p class="price">$69.008</p>
                    <ul class="reviews">
                      <li class="yellow"><i class="ti-star"></i></li>
                      <li class="yellow"><i class="ti-star"></i></li>
                      <li class="yellow"><i class="ti-star"></i></li>
              ...
              <!-- Single Widget -->
              <div class="single-widget category">
                <h3 class="title">Manofactureras</h3>
                <ul class="categor-list">
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-hombre-1.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-mujer-2.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-hombre-2.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-mujer-3.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-hombre-3.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-mujer-4.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-hombre-4.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-mujer-5.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
                ...
                <div class="single-product">
                  <div class="product-img">
                    <a href="product-details.html">
                      <img
                        class="default-img"
                        src="static/static_template/images/product/producto-hombre-5.jpg"
                        alt="#"
                      />
                      <img
                        class="hover-img"
          ...
          <div class="inner">
            <div class="row">
              ...
              <div class="col-lg-6 col-12">
                <div class="right">
                  <img
                    src="static/static_template/images/payments.png"
                    alt="#"
                  />
                </div>
              </div>
